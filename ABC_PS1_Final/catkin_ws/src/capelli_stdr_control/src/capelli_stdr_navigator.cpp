...
int main(int argc, char **argv) {
    ...
    double yaw_rate = (M_PI)/6; // (PI/6)rad/sec yaw rate command
    double time_3_sec = 3.0; // should move 3 meters or (PI/2) rad in 3 seconds
    ...
    twist_cmd.linear.x=speed+0.02; //command to move forward
    ...
    twist_cmd.linear.x=0.0; //stop moving forward
    twist_cmd.angular.z=-yaw_rate; //and start spinning right in place
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
    ...
    twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed+0.25; //and move forward again, slightly longer
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
    ...
    twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed-0.25; //and move forward a little
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
    ...
    twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed+0.65; //and move forward 
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
    ...
    twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed-0.65; //and move forward a little
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
    ...
    twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed-0.35; //and move forward a little
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
    ...
    twist_cmd.angular.z=0.0; //and stop spinning in place 
    twist_cmd.linear.x=speed+0.65; //and move forward a lot
    timer=0.0; //reset the timer
    while(timer<time_3_sec) {
          twist_commander.publish(twist_cmd);
          timer+=sample_dt;
